...
This folder keeps small source snapshots of high-value prototypes that originally lived under `/Users/kk/Desktop/LitchCodex/outputs/`.

The original output folders remain untouched. These snapshots exist so the concepts survive account, workspace, or local-folder disruption through the `Litchi` GitHub repo.
...
- Do not copy `.git`, generated caches, screenshots, localStorage dumps, or private business data.
